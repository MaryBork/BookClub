...
books_1 = Book.create({title: "The Iliad",  pages:260 , year_published:1975 , image_url: "https://images-na.ssl-images-amazon.com/images/I/419x%2BHUZRrL.jpg "})
book_2 = Book.create({title: "The Odyssey", pages:269 , year_published:1962 , image_url: "https://images-na.ssl-images-amazon.com/images/I/41t%2BKlNI4%2BL._SX332_BO1,204,203,200_.jpg "})
book_3 = Book.create({title: "Aeschylus I: Oresteia: Agamemnon, The Libation Bearers, The Eumenides(The Complete Greek Tragedies)(Vol 1)", pages:170 , year_published:1969 , image_url: "https://images-na.ssl-images-amazon.com/images/I/514B7BcZuKL._SX320_BO1,204,203,200_.jpg "})
book_4 = Book.create({title: "Aeschylus II: The Suppliant Maidens and The Persians, Seven against Thebes and Prometheus Bound (The Complete Greek Tragedies)",  pages:188 , year_published:1992 ,image_url: "https://images-na.ssl-images-amazon.com/images/I/51JdGmN746L._SX326_BO1,204,203,200_.jpg "})
book_5 = Book.create({title: "The Complete Greek Tragedies: Sophocles I",  pages:218 , year_published:1991 , image_url: "https://images-na.ssl-images-amazon.com/images/I/51%2BoIEyVJXL._SX326_BO1,204,203,200_.jpg "})
book_6 = Book.create({title: "Sophocles II: Ajax, The Women of Trachis, Electra & Philoctetes (The Complete Greek Tragedies)", pages:260 , year_published:1969 , image_url: "https://images-na.ssl-images-amazon.com/images/I/51tB5MiI8zL._SX326_BO1,204,203,200_.jpg"})
book_7 = Book.create({title: "The Peloponnesian War", pages:668 , year_published:1989 ,image_url: "https://images-na.ssl-images-amazon.com/images/I/41RHRL9zpQL._SX326_BO1,204,203,200_.jpg"})
book_8 = Book.create({title: "Euripides I: Alcestis, The Medea, The Heracleidae, Hippolytus (The Complete Greek Tragedies) (Vol 3)", pages:220 , year_published:1955 , image_url: "https://images-na.ssl-images-amazon.com/images/I/41GGDWb3jWL._SX470_BO1,204,203,200_.jpg"})
book_9 = Book.create({title: "Euripides V: Electra, The Phoenician Women, The Bacchae (The Complete Greek Tragedies) (Vol 5) ", pages:227 , year_published:1969 ,  image_url: "https://images-na.ssl-images-amazon.com/images/I/51MTjSwnIzL._SX326_BO1,204,203,200_.jpg"})
book_10 = Book.create({title: "Histories", pages:710 , year_published:1988 ,  image_url: "https://images-na.ssl-images-amazon.com/images/I/51fQOADAxKL._SX326_BO1,204,203,200_.jpg"})
book_11 = Book.create({title: "Four Plays by Aristophanes: The Birds; The Clouds; The Frogs; Lysistrata (Meridian Classics)", pages:619 , year_published:1994 , image_url: "https://images-na.ssl-images-amazon.com/images/I/41WpQ34jAgL._SX338_BO1,204,203,200_.jpg"})
book_12 = Book.create({title: "Meno",  pages:96 , year_published:1998, image_url: "https://images-na.ssl-images-amazon.com/images/I/41BumrwN16L._SX332_BO1,204,203,200_.jpg"})
book_13 = Book.create({title: "Gorgias", pages:168, year_published:1998, image_url: "https://images-na.ssl-images-amazon.com/images/I/31NKNCYX3AL._SX312_BO1,204,203,200_.jpg"})
